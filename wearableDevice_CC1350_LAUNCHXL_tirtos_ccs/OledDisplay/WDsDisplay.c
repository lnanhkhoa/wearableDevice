...
//    colon_status = true;
    ...
    AdafruitSSD1306_setCursor(clock_cursor[0], clock_cursor[1]);
...
void WDsDisplay__Colon_toogle(void){
    ...
    AdafruitSSD1306_setTextSize(clock_textSize);
    AdafruitSSD1306_setTextColor(clock_textColor);
    AdafruitSSD1306_setCursor(clock_cursor[0] + 6*clock_textSize*2, clock_cursor[1]);
...
void WDsDisplay__Heartrate_status(void){
    ...
    switch(heart_status){
    case 0: AdafruitSSD1306_drawBitmap(heart_x, heart_y, cardiogram , sizeBigHeart[0], sizeBigHeart[1], 1, 0); break;
    case 1: AdafruitSSD1306_drawBitmap(heart_x, heart_y, cardiogram1, sizeBigHeart[0], sizeBigHeart[1], 1, 0); break;
    case 2: AdafruitSSD1306_drawBitmap(heart_x, heart_y, cardiogram2, sizeBigHeart[0], sizeBigHeart[1], 1, 0); break;
    case 3: AdafruitSSD1306_drawBitmap(heart_x, heart_y, cardiogram3, sizeBigHeart[0], sizeBigHeart[1], 1, 0); break;
...
void WDsDisplay__Heartrate_number(int8_t number){ // -1 is wait
    ...
    if (number<0){
        ...
        AdafruitSSD1306_setCursor(heart_x + sizeBigHeart[0] + padding, heart_y + padding);
        print((uint8_t*)buffer);
        return;
    }
    ...
    switch(stringlen){
    case 1: AdafruitSSD1306_setCursor(heart_x + sizeBigHeart[0] + padding + (3*font_width)*1, heart_y + padding); break;
    case 2: AdafruitSSD1306_setCursor(heart_x + sizeBigHeart[0] + padding + (3*font_width)*1, heart_y + padding); break;
    case 3: AdafruitSSD1306_setCursor(heart_x + sizeBigHeart[0] + padding, heart_y + padding); break;
    default: break;
    }
    print((uint8_t*)buffer);
    return;
...
void WDsDisplay__Footsteps_status(void){
    ...
    if(footsteps_status)
        AdafruitSSD1306_drawBitmap(footsteps_x, footsteps_y, footsteps , sizeFootsteps[0], sizeFootsteps[1], 1, 0);
    else
        AdafruitSSD1306_drawBitmap(footsteps_x, footsteps_y, footsteps1, sizeFootsteps[0], sizeFootsteps[1], 1, 0);
}
...
void WDsDisplay__Footsteps_number(uint32_t number){
    ...
    int8_t stringlen = strlen(buffer);
    switch(stringlen){
        case 1: AdafruitSSD1306_setCursor(heart_x + sizeBigHeart[0] + padding + (2*font_width)*2, heart_y + padding_y); break;
        case 2: AdafruitSSD1306_setCursor(heart_x + sizeBigHeart[0] + padding + (2*font_width)*2, heart_y + padding_y); break;
        case 3: AdafruitSSD1306_setCursor(heart_x + sizeBigHeart[0] + padding + (2*font_width)*1, heart_y + padding_y); break;
        case 4: AdafruitSSD1306_setCursor(heart_x + sizeBigHeart[0] + padding + (2*font_width)*1, heart_y + padding_y); break;
        case 5: AdafruitSSD1306_setCursor(heart_x + sizeBigHeart[0] + padding, heart_y + padding_y); break;
        default: break;
    }
    print((uint8_t*)buffer);
}
