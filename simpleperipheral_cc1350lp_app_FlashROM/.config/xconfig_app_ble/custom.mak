...
linker.cmd: package/cfg/app_ble_pem3.xdl
	$(SED) 's"^\"\(package/cfg/app_ble_pem3cfg.cmd\)\"$""\"C:/Users/AppsTI/workspace_blestack/simple_peripheral_cc1350lp_app_FlashROM/.config/xconfig_app_ble/\1\""' package/cfg/app_ble_pem3.xdl > $@
